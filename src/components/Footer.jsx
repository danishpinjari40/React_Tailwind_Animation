...
const Footer = () => {
	return (
		...
		className="flex gap-5 w-full h-screen bg-zinc-900 p-20 font-['Test_Founders_Grotesk_X-Cond_SmBd']">
			<div className="w-1/2 h-full flex flex-col justify-between ">
				<div className="heading">
					<h1 className="text-[7vw] font-semibold uppercase leading-none -mb-10">
						Eye-
					</h1>
					<h1 className="text-[7vw] font-semibold uppercase leading-none mt-4">
						Opening
					</h1>
				</div>
				<svg
